...
import br.com.cten.financask.extension.converteParaCalendar
...
class AdicionaTransacaoDialog(private val context: Context,
        ...
        AlertDialog.Builder(context)
                ...
                .setPositiveButton("Adicionar",
                        { _, _ ->
                            ...
                            val valor: BigDecimal = converteCampoValor(valorEmTexto)
                            ...
                            // Delegate: envia a responsabilidade para quem chamou
    ...
    private fun configuraCampoData() {
        ...
        // Nesse caso é necessário utilizar o setText() ao invés da property porque é um editText
        campoData.setText(hoje.formataParaBrasileiro())
        campoData.setOnClickListener {
                    DatePickerDialog(context, { _, ano, mes, dia ->
                                // _ significa que este parametro não estará sendo usado
