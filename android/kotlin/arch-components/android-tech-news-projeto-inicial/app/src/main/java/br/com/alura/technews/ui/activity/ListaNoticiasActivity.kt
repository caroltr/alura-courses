...
class ListaNoticiasActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        // Este provedor sempre retorna os dados atuais e respeitando o lifecycle
        val provedor = ViewModelProviders.of(this, factory) // factory porque view model em questao requer parametro
